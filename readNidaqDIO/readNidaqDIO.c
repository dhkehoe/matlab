...
Usage:
    readNidaqDIO(deviceNumber, portNumber, channelNumber)
...
the MATLAB Command Window:
    mex readNidaqDIO.c nidaqmx.lib -L'C:\Program Files (x86)\National Instruments\Shared\ExternalCompilerSupport\C\lib64\msvc' -I'C:\Program Files (x86)\National Instruments\Shared\ExternalCompilerSupport\C\include'
...
#define READ_ARRAY_SIZE_IN_BYTES    1
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    **********************/
    ...
    // No error
        ...
        plhs[0] = mxCreateNumericMatrix(1, READ_ARRAY_SIZE_IN_BYTES, mxDOUBLE_CLASS, mxREAL); // initialize output
